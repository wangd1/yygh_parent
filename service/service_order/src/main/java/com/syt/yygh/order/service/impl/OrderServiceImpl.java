...
import com.syt.yygh.enums.OrderStatusEnum;
import com.syt.yygh.hosp.client.HospFeignClient;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper,OrderInfo> implements OrderService{
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        // 获取排班信息
        ScheduleOrderVo schedule = hospFeignClient.getScheduleOrder(scheduleId);
        if(null == schedule) {
            throw new YyghException(ResultCodeEnum.PARAM_ERROR);
        }
        // 判断当前时间是否还可以预约
        ...
        // 获取签名信息
        SignInfoVo signInfoVo = hospFeignClient.getSignInfoVo(schedule.getHoscode());
        // 添加到订单表
        ...
        // 调用医院接口，执行下单操作
        requestHospManager(patient,orderInfo,signInfoVo,scheduleId);
    ...
    private void requestHospManager(Patient patient,OrderInfo orderInfo,SignInfoVo signInfoVo,String scheduleId){
        ...
        if(result.getInteger("code") == 200) {
            ...
            smsVo.setTemplateCode("SMS_194640721");
            String reserveDate =
